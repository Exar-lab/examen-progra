...
public class Cliente {
    ...
    @Column(nullable = false) private String nacionalidad;
     ...
     * @param nacionalidad        nacionalidad declarada por el cliente
    ...
    public Cliente(@NonNull final String nombres, @NonNull final String apellidos,
                   @NonNull final String documentoIdentidad, @NonNull final String nacionalidad,
